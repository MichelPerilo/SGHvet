...
CREATE TABLE disponibilidade_vet(
    ...
    dia enum('Segunda','Terça','Quarta','Quinta','Sexta','Sábado','Domingo'),
...
CREATE TABLE membro_cirurgia (
  ...
  PRIMARY KEY (id),
	FOREIGN KEY(id_cirur) REFERENCES cirurgia(cod_cirur),
...
PRIMARY KEY (id), 
FOREIGN KEY (id_intemEstoque) REFERENCES intem_estoque(id_intem_estoque)
ON DELETE CASCADE
)ENGINE = InnoDB;
...
nome VARCHAR(45) NOT NULL,
tipo enum ('Analgesicos', 'Antibioticos', 'Antiflamatorio') not null,
...
-- -----------------------------------------------------
-- Table `bdsghvet`.`requisicaoFarmaco`
-- -----------------------------------------------------
 
 CREATE TABLE IF NOT EXISTS requisicaoFarmaco(
id INT auto_increment,
...
foreign key(idConsulta) references consulta (id)
 ...
 -- -----------------------------------------------------
-- Table `bdsghvet`.`requisicaoFarmacoCirurgia`
-- -----------------------------------------------------
 
  CREATE TABLE IF NOT EXISTS requisicaoFarmacoCirurgia(
id INT auto_increment,
quantidade int not NULL,
descricao VARCHAR(45) NOT NULL,
justificativa VARCHAR(45) NOT NULL,
...
PRIMARY KEY (id),
foreign key(idmedico) references veterinario (cpf),
foreign key(idCirurgia) references cirurgia (cod_cirur)


)ENGINE = InnoDB;
 
 CREATE TABLE IF NOT EXISTS requisicaoFarmacoSolicitadas(

id INT auto_increment,
dataSolicitada date,
idrequisicao int,
tipo enum('CLINICO', 'CIRURGICO'),
...
INSERT INTO sghvet.administrativo (nome, cpf, dataNasc, cargo, contato, email) VALUES ('GOD OF WAR', '10103566406', '1990-12-30', 'ADMINISTRADOR', '99998888', 'adm@adm.com');
INSERT INTO sghvet.veterinario (nome, cpf, dataNasc, cargo, contato, email , crmv) VALUES ('GOD OF WAR', '10103566406', '1990-12-30', 'CLINICO', '99998888', 'adm@adm.com', '0000');
INSERT INTO sghvet.auxiliar (nome, cpf, dataNasc, cargo,crf,contato, email) VALUES ('admS', '10103566406', '1990-12-30', 'LABORATORIO','2132', '99998888', 'adm@adm.com');
