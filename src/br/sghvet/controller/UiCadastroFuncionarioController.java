	...
	public void atualizar() throws Exception {
		...
		if(bt_atualizar.getText().equals("Salvar")) {
			...
			case ADMINISTRATIVO:
				...
				Administrativo adm = new Administrativo(textfield_nome1.getText(), textfield_cpf1.getText(), datepicker_datanascimento1.getValue(),administrativo.getCargo(),textfield_contato1.getText() , textfield_email1.getText());
	            objeto = adm;
			...
			case AUXILIAR:
				...
				Auxiliar auxi = new Auxiliar(textfield_nome1.getText(), textfield_cpf1.getText(), datepicker_datanascimento1.getValue(),auxiliar.getCargo(),textfield_contato1.getText() , textfield_email1.getText());
				objeto = auxi;
			...
			case VETERINARIO:
				...
				Veterinario vet = new Veterinario(textfield_nome1.getText(), textfield_cpf1.getText(), datepicker_datanascimento1.getValue(),veterinario.getCargo(),textfield_contato1.getText() , textfield_email1.getText(),veterinario.getCrmv());
				objeto = vet;
