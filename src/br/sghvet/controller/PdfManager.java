...
public class PdfManager {
	public void requisicaoExame(RequisicaoExame req) throws Exception {
		...
		document.add(new Paragraph().add("Código:").add(new Tab()).add(new Tab()).add(new Tab()).add(new Tab())
		...
		document.add(new Paragraph().add("Raça: ").add(new Tab()).add(new Tab()).add(new Tab()).add(new Tab())
				.add(animal.getRaça()));
		...
		document.add(
				new Paragraph().add("Data de realização dos exames: ").add(new Tab()).add(req.getData().toString()));
	...
	public void resultadoExame(ResultadoExame result) throws Exception {
		...
		document.add(
				new Paragraph().add("_____________________________________________________________________________"));
		document.add(new Paragraph().add("MEDIÇÕES")).setBold();
		...
		document.add(
				new Paragraph().add("_____________________________________________________________________________"));
		document.add(new Paragraph().add("CABEÇA E PESCOÇO").setBold());
		document.add(new Paragraph());
		document.add(new Paragraph().add("Resultado da cabeça e pescoço, bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,"));
		document.add(new Paragraph());
		document.add(
				new Paragraph().add("_____________________________________________________________________________"));
		canvas.setStrokeColor(color).moveTo(36, 36).lineTo(36, 806).lineTo(556, 806).lineTo(556, 36).closePathStroke();
		document.add(new Paragraph().add("CAVIDADE TORÁCICA").setBold());
		document.add(new Paragraph());
		document.add(new Paragraph().add("Resultado da cavidade torácica, bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,"));
		document.add(new Paragraph());
		document.add(
				new Paragraph().add("_____________________________________________________________________________"));
		...
		document.add(new Paragraph());
		document.add(new Paragraph().add("O prognostico é bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,bla,"));
		document.add(new Paragraph());
