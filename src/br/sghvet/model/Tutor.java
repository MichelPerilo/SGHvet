...
public class Tutor{
	...
	// atributos
		...
		private ArrayList<Prontuario> pontuario;
		...
		public Tutor(String nome, String cpf, String rg, String datEmissao,
				String orgaoEmissao, String sexo, String telefone,
				String estadoCivil, Endereço endereco) {
